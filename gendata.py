...
def get_investment_returns_data(ticker):
    ...
    for i, row in data.iterrows():
        ...
        if isnan == False:
            ...
            cumulativeCost = round(cumulativeCost + currentPrice, 2)
    ...
    ax.ticklabel_format(axis='y', style='', useOffset=False)
...
def main():
    print("Hello World!")
    ticker = 'SPY QQQ'
    get_investment_returns_data('SPY QQQ')
    plt, df = get_investment_returns_data(ticker)
